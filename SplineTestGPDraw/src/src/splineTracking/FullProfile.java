...
public class FullProfile {
	...
	motionProfileDecelerateVel, tolerance = 0.00000001;
	...
	public FullProfile(double Kp, double Ki, double Kd, double Ka,
			double Kv){
		this.Kp = Kp;
		this.Ki = Ki;
		this.Kd = Kd;
	...
	public boolean isFinishedTrajectory() {
		...
		resetTolerance();
        return Math.abs(currentOuterSegment.pos - totalDistance) < tolerance;
